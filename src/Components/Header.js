...
import FamousCategoryPopup from "./FamousCategoriesPopup";
...
function Header ()
{
    ...
    const navRef = useRef();
    const [showFamousCategories, setShowFamousCategories] = useState(false);
    const handleLogout = () => {
        logout();
        navigate('login');
    };
    ...
    const handleAllItemsClick = () => {
        showNavbar();
        setShowFamousCategories(false); // Close the dropdown if it's open
        navigate('/All_items');
      };
   
    const toggleFamousCategories = () => {
        setShowFamousCategories(!showFamousCategories);
      };
   useEffect(()=>
   {
    console.log(user);
...
//   };
    return(
        <div className="Header_Center">
                ...
                <nav ref={navRef}>
                    <Link to="/SpecialDeals"><div className="Nav-Elements" onClick={SpecialDeals}>
                        Special Deals
                    </div></Link>
                <Link to = "/All_items">
                    <div className="Nav-Elements" onClick={handleAllItemsClick}>
                        All Items
                    </div>
                </Link>
                <div className="Nav-Elements" onClick={toggleFamousCategories}>
                   Products Category
                </div>
                
                {showFamousCategories && (
                    <FamousCategoryPopup onClose = {toggleFamousCategories}/>
                )}
